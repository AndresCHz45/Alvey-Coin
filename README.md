...
* [AlveyCoin Book - A Developer's Guide To ALVEY](http://book.alvey.site/en/)
...
* alvey.info API that powers the block explorer and the ALVEY Web wallet
...
User documentation https://github.com/alveyproject/documents/tree/master/en/ALVEY-WebWallet-usage
