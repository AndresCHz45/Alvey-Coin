...
void BitcoinGUI::createActions()
{
    ...
    ALVEYTokenAction = new QAction(platformStyle->MultiStatesIcon(":/icons/alveytoken"), tr("&QRC Tokens"), this);
    ALVEYTokenAction->setStatusTip(tr("QRC Tokens (send, receive or add Tokens in list)"));
    ALVEYTokenAction->setToolTip(ALVEYTokenAction->statusTip());
    ALVEYTokenAction->setCheckable(true);
    ALVEYTokenAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_5));
    tabGroup->addAction(ALVEYTokenAction);
    ...
    connect(ALVEYTokenAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(ALVEYTokenAction, SIGNAL(triggered()), this, SLOT(gotoTokenPage()));
...
void BitcoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        appNavigationBar->addAction(ALVEYTokenAction);
...
void BitcoinGUI::setClientModel(ClientModel *_clientModel)
{
    ...
    if(_clientModel)
    {
        ...
        {
            QString link = QString("<a href=%1>%2</a>").arg(ALVEY_RELEASES, ALVEY_RELEASES);
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    ALVEYTokenAction->setEnabled(enabled);
...
{
    ALVEYTokenAction->setChecked(true);
