    ...
    walletFrame(qobject_cast<WalletFrame*>(parent))
{
    ...
    ALVEYTokenPage = new ALVEYToken(platformStyle);
    ...
    // Pass through messages from ALVEYTokenPage
    connect(ALVEYTokenPage, &ALVEYToken::message, this, &WalletView::message);
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    ALVEYTokenPage->setClientModel(_clientModel);
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    ALVEYTokenPage->setModel(_walletModel);
...
{
    setCurrentWidget(ALVEYTokenPage);
}
