...
static UniValue lrc20name(const JSONRPCRequest& request)
{
            RPCHelpMan{"lrc20name",
...
static UniValue lrc20symbol(const JSONRPCRequest& request)
{
...
static UniValue lrc20totalsupply(const JSONRPCRequest& request)
{
...
static UniValue lrc20decimals(const JSONRPCRequest& request)
{
...
static UniValue lrc20balanceof(const JSONRPCRequest& request)
{
...
static UniValue lrc20allowance(const JSONRPCRequest& request)
{
...
static UniValue lrc20listtransactions(const JSONRPCRequest& request)
{
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    { "blockchain",         "lrc20name",              &lrc20name,              {"address"} },
    { "blockchain",         "lrc20symbol",            &lrc20symbol,            {"address"} },
    { "blockchain",         "lrc20totalsupply",       &lrc20totalsupply,       {"address"} },
    { "blockchain",         "lrc20decimals",          &lrc20decimals,          {"address"} },
    { "blockchain",         "lrc20balanceof",         &lrc20balanceof,         {"contractaddress", "address"} },
    { "blockchain",         "lrc20allowance",         &lrc20allowance,         {"contractaddress", "addressFrom", "addressTo"} },
    { "blockchain",         "lrc20listtransactions",  &lrc20listtransactions,  {"contractaddress", "address", "startblock", "minconf"} },
